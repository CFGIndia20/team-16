...
GetOldTweets3 --querysearch "museum" --near "55.75, 37.61" --within 40km --maxtweets 10
 ...
 GetComplaintsFromTwitter --querysearch "potholes" --near "55.75, 37.61" --within 40km --maxtweets 10
"""
...
def main(argv):
    ...
    with open('categories.csv', 'r') as read_obj:
    ...
    try:
        ...
        for opt, arg in opts:
            if opt == '--querysearch':
                ...
                outputFileName = tweetCriteria.querySearch+".csv"
